...
def sf_so_line_data_query(
    ...
    AVG_PER_SILHOUETTE AS (
        ...
        INNER JOIN (SELECT SO_DOC_HDR_NBR, SILH_DESC, SO_HDR_CRT_DATE FROM EMEA_DA_FDN_PROD.MPO.ORDERBOOK_FOUNDATION GROUP BY SO_DOC_HDR_NBR, SILH_DESC, SO_HDR_CRT_DATE) OBF
...
AVG_PER_CUSTOMER AS (
        ...
        INNER JOIN EMEA_DA_CONS_PROD.DCDASH.VIEW_CONSUMABLE_OUTBOUND_DELIVERY_DOC_DETAIL DD
            ...
            AND CI.PRODUCT_CODE = DD.PRODUCT_CODE
            AND CI.SIZE_CODE = DD.SIZE_CODE 
        RIGHT JOIN (SELECT SO_DOC_HDR_NBR, SO_HDR_CRT_DATE, CUST_SHIP_TO_CD FROM EMEA_DA_FDN_PROD.MPO.ORDERBOOK_FOUNDATION GROUP BY SO_DOC_HDR_NBR, SO_HDR_CRT_DATE, CUST_SHIP_TO_CD) OBF
            ON DD.SALES_ORDER_NUMBER = OBF.SO_DOC_HDR_NBR
