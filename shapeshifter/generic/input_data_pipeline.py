...
from shapeshifter.utils import generic_functions, spark_helper
...
class InputDataPipeline(DataPipeline):
    def __init__(
        ...
        """
        super().__init__()
        self.__s3_endpoint_bucket = f"{self.env_config.get('aws.s3_endpoint')}/{self.env_config.get('wi_s3_bucket')}"
        self.__s3_path_key = (
